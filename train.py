...
def config_mlflow():
    MLFLOW_TRACKING_URI = 'https://dagshub.com/rafaelziller1999/mlops_puc_aula03.mlflow'
    MLFLOW_TRACKING_USERNAME = 'rafaelziller1999'
    MLFLOW_TRACKING_PASSWORD = '56d82497b771897351e99a65146c0eb0d87b65bd'
...
def train_model(model, X_train, y_train, is_train = True):
    ...
    if is_train:
        ...
        mlflow.register_model(run_url, 'fetal_health')
